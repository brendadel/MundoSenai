...
namespace Fighter_Jet_Shooting_Game_MOO_ICT
{
    public partial class Form1 : Form
    {
        ...
        private void mainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            // lógica de movimento do jogador começa
            ...
            // a lógica de movimento do jogador termina
        ...
        private void gameOver()
        {
            isGameOver = true;
            gameTimer.Stop();
            txtScore.Text += Environment.NewLine + "Fim de jogo!!" + Environment.NewLine + "Pressione Enter para tentar novamente.";
