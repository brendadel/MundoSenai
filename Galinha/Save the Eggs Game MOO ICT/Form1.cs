...
namespace Save_the_Eggs_Game_MOO_ICT
{
    public partial class Form1 : Form
    {
        ...
        private void MainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            txtScore.Text = "Salvos: " + score;
            txtMiss.Text = "Perdidos: " + missed;
            ...
            {
                GameTimer.Stop();
                MessageBox.Show("Fim do jogo!" + Environment.NewLine + "Perdemos bons ovos!" + Environment.NewLine + "Clique em ok para tentar novamente!");
                RestartGame();
            }
